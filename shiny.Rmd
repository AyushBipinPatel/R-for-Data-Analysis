...
Make a small shiny app that produces a plot(ggplot) by allowing a user to choose variables.
use the Iris data. Try `r ?iris` in your console to get a sense of the data.
