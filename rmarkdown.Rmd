...
# Step 2 - Showing and hiding the code
  ...
  + In the second code chunk write a code to count island in palmerpenguins, .big[set 'echo=FALSE']<br><br>
...
# The `eval` option
  ...
  _Setting it to true means that this particular chunk will not be executed_
